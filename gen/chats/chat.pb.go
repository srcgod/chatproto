...
const file_chat_proto_rawDesc = "" +
	...
	"\n" +
	"is_success\x18\x01 \x01(\bR\tisSuccess\"K\n" +
	"\x11CreateChatRequest\x12\x19\n" +
	"\buser_ids\x18\x01 \x03(\x03R\auserIds\x12\x1b\n" +
	"\tchat_name\x18\x02 \x01(\tR\bchatName\"H\n" +
	...
	".chat.ChatR\x05chats\"t\n" +
	"\x04Chat\x12\x19\n" +
	"\buser_ids\x18\x01 \x03(\x03R\auserIds\x12\x17\n" +
	"\achat_id\x18\x02 \x01(\tR\x06chatId\x12\x1b\n" +
	"\tchat_name\x18\x03 \x01(\tR\bchatName\x12\x1b\n" +
	"\tchat_type\x18\x04 \x01(\tR\bchatType2\xe1\x01\n" +
	"\vChatService\x12?\n" +
	"\n" +
